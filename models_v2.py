...
class LabelEmbedder(nn.Module):
    ...
    def __init__(self, text_embedding, hidden_size, dropout_prob):
        ...
        self.conv = nn.Conv1d(16, 4, 1, 1, 0, bias=True)
    ...
    def forward(self, labels, train, attn_mask=None, force_drop_ids=None):
        ...
        embeddings = self.mlp(self.conv(labels))  # shape: (batch_size, hidden_size)
        return embeddings
...
class DiTBlock(nn.Module):
    ...
    def __init__(self, hidden_size, num_heads, mlp_ratio=4.0, **block_kwargs):
        ...
        self.single_token_modulation =  nn.Conv1d(4, 1, 1, 1, 0, bias=True)

    def forward(self, x, c):
        shift_msa, scale_msa, gate_msa, shift_mlp, scale_mlp, gate_mlp = self.single_token_modulation(self.adaLN_modulation(c)).chunk(6, dim=2)
...
class FinalLayer(nn.Module):
    ...
    def __init__(self, hidden_size, patch_size, out_channels):
        ...
        self.single_token_modulation =  nn.Conv1d(4, 1, 3, 1, 1, bias=True)

    
    def forward(self, x, c):
        shift, scale = self.single_token_modulation(self.adaLN_modulation(c)).chunk(2, dim=2)
...
class DiT(nn.Module):
    ...
    def initialize_weights(self):
        ...
        nn.init.normal_(self.y_embedder.mlp[3].weight, std=0.02)
    ...
    def forward(self, x, t, y, attn_mask=None):
        ...
        y = self.y_embedder(y, self.training, attn_mask)    # (N, D)
