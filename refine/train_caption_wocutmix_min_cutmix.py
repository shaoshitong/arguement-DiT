...
"""
from sample_refine_class import ImageSampler
...
import pandas as pd
import random
from dataset.dataset_cutmix import CustomDataset
...
from models_shao import DiT_models
...
def main(args):
    ...
    sampler_refine = ImageSampler(model="DiT-XL/2", image_size=256, num_classes=1000, num_sampling_steps=200, cfg_scale=1.5,seed=0,ckpt="/share/Rui_Huang/Janus_D_Refine/DiT-XL-2-256x256.pt")
    ...
    for epoch in range(args.epochs):
        ...
        for x,cutmix_x, text,class_idx in loader:
        # for x,y in loader:
            with torch.no_grad():
                sampled_images = sampler_refine.sample_images(cutmix_x,class_idx,device,vae)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--select_info", type=str, default = "/share/Rui_Huang/Janus_D_Refine/samples/DiT-XL-2-DiT-XL-2-256x256-size-256-vae-ema-cfg-1.5-seed-0/merged.json")
