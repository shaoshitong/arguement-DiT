...
class CustomDataset(Dataset):
    def __init__(self, root, image_size, transform=None):
        ...
        for class_dir in class_dirs:
            ...
            label_path = class_dir / "labels.npy"
            image_paths = sorted(list(img_dir.glob("*.JPEG")))
            labels = np.load(label_path)

            assert len(image_paths) == len(labels), f"Label count mismatch in {class_dir.name}"
...
def main(args):
    ...
    cutmix_dataset = CustomDataset(args.cutmix_data_path,image_size=args.image_size,transform=transform)
    ...
    for epoch in range(args.epochs):
        ...
        for (x, y), (cutmix_x, cutmix_y) in zip(loader, cutmix_loader):
        # for x,y in loader:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default = "/home/shaoshitong/project/argument-DiT/dataset/tiny-imagenet-200/train")
    parser.add_argument("--cutmix_data_path", type=str, default = "/home/shaoshitong/project/argument-DiT/dataset/tiny-imagenet-200/cutmix_train")
